        ...
        stage('Upload JSON'){
            steps{
                script{
                    ...
                    snDevOpsConfigUpload(applicationName:"${appName}",changesetNumber:"${changeset}",target:"deployable",dataFormat:"json",configFile:"FileA.json",namePath:"${namePath}",deployableName:"${deployName}",autoCommit:true,autoValidate:true)
